...
# # Set the page configuration with custom colors
# st.set_page_config(
#     page_title="Text Analysis App",
#     page_icon="📊",
#     layout="wide",
#     initial_sidebar_state="expanded",
#     background_color="#f5f5f5",  # Set your desired background color
#     text_color="#333333",       # Set your desired text color
#     primary_color="#ff5733",    # Set your desired primary color
# )
